...
{
    /// <summary>
    /// A class that represents a Tracking Shooter Fish.
    /// </summary>
    public class TrackingShooterFish : Enemy
    {

        int counter = 0;

        public static Texture2D TrackingShooterFish2Texture;
        ...
        public TrackingShooterFish(Level.Level AssociatedLevel, int y)
        {
            ...
            this.MaxHP = 2;
            this.Scale = 1f;
            this.Texture = TrackingShooterFish2Texture;
        ...
        /// <param name="y">The Y position of the enemy.</param>
        public TrackingShooterFish(Level.Level AssociatedLevel, int x, int y)
        {
            this.AssociatedLevel = AssociatedLevel;
